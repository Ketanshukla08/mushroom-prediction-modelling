...
print(mutual_info_regression(df.ix[:,1::], df.ix[:,0]))
...
#here we can see from distribution plot that veil-color feature have almost constant value over their columns
...
print(100*LR.score(testX,testY))
